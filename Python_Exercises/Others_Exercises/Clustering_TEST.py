...
X=np.transpose(D[:,0:4000]) 

from sklearn.cluster import KMeans
# Setting of the KMenas algorithm (KMeans ++)
...
# Result from KMeans
fig, ax = plt.subplots(figsize=(4, 3)) # This creates the figure
plt.plot(range(1,11),distor,'ko')
...
# Get Clusters
Baricenters=km.cluster_centers_

k=3
nxny=int(nxny)
D_MEAN=Baricenters[k,:]
