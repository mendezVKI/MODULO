...
from modulo.modulo import MODULO # to create modulo objects
...
plt.tight_layout()
Name=FOLDER_JET_RESULTS+os.sep+'Snapshot_JET_'+str(SNAP)+'.png'
...
D = ReadData._from_dat(folder='./Tutorial_2_JET_PIV/', filename='Res%05d', 
...
FOLDER_SPOD_RESULTS=FOLDER_JET_RESULTS+os.sep+'SPOD_s_Results_Jet'
if not os.path.exists(FOLDER_SPOD_RESULTS):
    os.mkdir(FOLDER_SPOD_RESULTS)
...
FOLDER_MPOD_RESULTS=FOLDER_JET_RESULTS+os.sep+'MPOD_Results_Jet'
