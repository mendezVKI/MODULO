...
caxis([0 50]) % From here  downward is just for plotting purposes
axis([-15 15 -15 15])
...
Keep=[1 1 0]; %These are the band-pass you want to keep (Approximation is always kept).
Nf=[250 250 150]; % This vector collects the length of the filter kernels.
