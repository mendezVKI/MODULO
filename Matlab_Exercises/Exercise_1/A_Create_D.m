...
STEP_S=ones(size(t)); % Initialize the step
STEP_S(1:floor(n_t/10))=0; STEP_S(end-floor(n_t/10):end)=0; % Step Definition
...
% Observe the time evolution in the centerline for each
 HFIG=figure(11); HFIG.Units='normalized'; HFIG.Position=[0.45 0.45 0.45 0.45];
 hold on
