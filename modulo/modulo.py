...
class MODULO:
    ...
    def __init__(self, data: np.array,
                 ...
                 is_cartesian: tuple = (True, (None, None))):
        """
        ...
        If the memory saving is active, the folder with partitions should be prepared.  
    ...
    def compute_mPOD(self, Nf, Ex, F_V, Keep, SAT, boundaries, MODE, dt, SAVE=False):
        ...
        if  hasattr(self, 'D'): # if self.D is available
         ...
         print('Computing correlation matrix from partitions...')   
         self.K = CorrelationMatrix(self.N_T, self.N_PARTITIONS, 
                                    self.MEMORY_SAVING,
