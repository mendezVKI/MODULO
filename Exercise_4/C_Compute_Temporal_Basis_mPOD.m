...
% this is shown in Fig. 24 of the article.  We compute our frequency
% splitting vector in terms of Strouhal number.
H=4/1000; % Stand off distance nozzle to plate
U0=6.5; % Mean velocity of the jet at the outlet

F_V=[100 200 300 400]; % This will generate four scales: H_A, H_H_1, H_H_2, H_H_3. See Sec. 3.2
St=F_V*H/U0;
