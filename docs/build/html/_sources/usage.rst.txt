...
the methods (see "Computing decompositions"). 
For example, here is how to initialize the modulo object passing the dataset matrix D and use the method compute_POD_K() 
to perform the POD.
