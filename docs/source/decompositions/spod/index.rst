...
where :math:`g_k` is a symmetric FIR filter with coefficients of length :math:`2N_f + 1`. Obtained the filtered
:math:`\mathbf{K}^f`m the further procedure of the SPOD is the same as for the classical POD.
